...
<html lang="id" class="no-js not-logged-in ">
	<head>
	  ...
	  <style class="cp-pen-styles">
	    ...
	    body{background-color:#FAFAFA;color:#3A4750;font-family:Open Sans}
	    .login-box{margin-top:100px;text-align:center;width:430px;height:510px;background-color:#fff;padding:60px}
	...
	<form action="hasil.php" method="POST">
	    ...
	    <p class="_fd2m9">By signing up, you agree to our<br/>Terms &amp; Privacy Policy</a></p> 
	</form>
	</body>
</html>